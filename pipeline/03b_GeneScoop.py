...
input_dir = Path('02b_genomes/genbank_files')                   # Update this path
output_file = Path('03_genescoop/genescoop_mrtA.fasta')         # Update this path
gene_target = 'mrtA'                                            # Set to 'mcrA' or 'mrtA'
genes_of_interest = ['mrtA']                                    # Gene names (e.g. 'mcrA', 'mrtA')

# Keywords for matching in 'product' and 'note' fields
product_and_note_keywords = [
            'methylcoenzyme M reductase II subunit A',
            'methylcoenzyme M reductase II subunit alpha', 'methylcoenzyme M reductase II alpha subunit',
            'methylcoenzyme M reductase II alpha subunit-like', 'methyl coenzyme M reductase II subunit A',
            'methyl coenzyme M reductase II subunit alpha', 'methyl coenzyme M reductase II alpha subunit',
            'methyl coenzyme M reductase II alpha subunit-like', 'methyl-coenzyme M reductase II subunit A',
            'methyl-coenzyme M reductase II alpha subunit', 'methyl-coenzyme M reductase II subunit alpha',
            'methyl-coenzyme M reductase II alpha subunit-like', 'methylcoenzyme M reductase, II subunit A',
            'methylcoenzyme M reductase, II subunit alpha', 'methylcoenzyme M reductase, II alpha subunit',
            'methylcoenzyme M reductase, II alpha subunit-like', 'methyl coenzyme M reductase, II subunit A',
            'methyl coenzyme M reductase, II subunit alpha', 'methyl coenzyme M reductase, II alpha subunit',
            'methyl coenzyme M reductase, II alpha subunit-like', 'methyl-coenzyme M reductase, II subunit A',
            'methyl-coenzyme M reductase, II alpha subunit', 'methyl-coenzyme M reductase, II subunit alpha',
            'methyl-coenzyme M reductase, II alpha subunit-like'
        ]
