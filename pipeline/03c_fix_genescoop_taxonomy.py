#!/usr/bin/env python3
"""
03c_fix_genescoop_taxonomy.py
Extract clean FASTA + QIIME2 taxonomy TSV from GeneScoop mcrA headers.

Input:
    03_genescoop/genescoop_mcrA.fasta

Outputs:
    03_genescoop/genescoop_clean_mcrA.fasta
    03_genescoop/genescoop_taxonomy_mcrA.tsv
"""

import re

INPUT_FASTA = '03_genescoop/genescoop_mcrA.fasta'
OUTPUT_FASTA = '03_genescoop/genescoop_clean_mcrA.fasta'
OUTPUT_TAX = '03_genescoop/genescoop_taxonomy_mcrA.tsv'
